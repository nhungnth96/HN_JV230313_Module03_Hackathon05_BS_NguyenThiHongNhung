...
public final class InputMethods {
    ...
    public static final String ERROR_STOCK = "===>> Vui lòng nhập số lượng lớn hơn 10";
    private static final String ERROR_PRODUCTID = "===>> Vui lòng nhập bắt đầu bằng chữ P và thêm 4 ký tự số";
    /*========================================Input Method Start========================================*/
...
//     * getInput()  Return any String value from the user.
    ...
    */
    ...
    public static String getProductId(){
        while(true){
            String result = getString();
            if(result.startsWith("P")&& result.length()==5){
                return result;
            } else {
                System.err.println(ERROR_PRODUCTID);;
            }
        }
    }
}
